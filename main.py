...
import  openpyxl
def load_data():
    path = 'C://Users//ADMIN//PycharmProjects//GUI_csv//tkinter-excel-app//people.xlsx'
...
combo_list= ['Subcribed','Not Subcribed','Other']
root = tk.Tk()
...
a=tk.BooleanVar()
checkbutton = ttk.Checkbutton(widgets_frame,text='Employeed', variable=a)
checkbutton.grid(row=3, column=0, sticky='ew')

button = ttk.Button(widgets_frame,text='Insert', command=insert_row)
button.grid(row=4, column=0, padx=5, pady=5,sticky='ew')

separator = ttk.Separator(widgets_frame)
separator.grid(row=5, column=0, padx =15,pady=10,sticky='ew')

mode_switch = ttk.Checkbutton(
    widgets_frame,text='Mode', style='Switch', command=tongle_mode
)
